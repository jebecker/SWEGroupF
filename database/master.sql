...
-- Columns:
--    pawprint      - The user name tied to authentication info. References user.
...
CREATE TABLE authentication (
	...
	FOREIGN KEY (pawprint) REFERENCES user(pawprint)
);
...
--    pawprint 		- The pawprint of the instructor teaching the course. References user.
...
--	pawprint	- The pawprint of the student who submitted the application.
...
--	pawprint 	- The pawprint of the instructor who made the comment. References user.
...
--    pawprint   - The user whose action generated this log entry. References user.
